...
aatrox = common.Class(function (s, hero)
  ...
  print("Loaded aatrox submodule")
end)

function aatrox:IsValidSpell (spell)
  ...
  if(spell.name == "AatroxQ")then return true end
  return false
end

function aatrox:recvspell (spell)
