...
namespace FoxyAshe.Modes
{
    internal class AntiCC
    {
        ...
        public AntiCC(Menu asheMenu, SpellManager spellManager)
        {
            //Init
        ...
        private void OnAddBuff(Obj_AI_Base sender, Obj_AI_BaseBuffGainedEventArgs args)
        {
            ...
            if (_menu.GetValue<bool>(_antiCCMenu, "cleanse") && _spellManager.Cleanse != null && _spellManager.Cleanse.IsReady() &&
