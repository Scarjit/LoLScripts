<?php
	...
	if ($m_secretkey != "" && $m_charName != "" && $m_username != "" && $m_authkey != "" && $m_iv != "" && $m_scriptkey != "") {
	...
	try{
	    ...
	    $sql_check_if_scriptkey_valid = $conn->prepare("SELECT script_id FROM scripts WHERE ScriptKey = :sk");
	    ...
	    $script_key = $sql_check_if_scriptkey_valid_fetched[0]["ScriptKey"];
	    ...
	    die(base64_encode("PDOException"));
	}
?>