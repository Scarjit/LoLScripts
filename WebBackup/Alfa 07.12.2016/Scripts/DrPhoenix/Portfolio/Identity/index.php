...
<html>
	...
	<body onbeforeunload="do_update()">
		<div class="content">
			...
			<div class="main">
				<h1 class="portfolio_title staff">Identity</h1>
				<center><a href="https://forum.botoflegends.com/user/599206-identity/" class="download_link">Identity BoL profile</a></center>
				
				<h2 class="sub_title">Avatar</h2>
				<img class="portfolio_img" src="avatar.gif">
				
				<h2 class="sub_title">Profile</h2>
