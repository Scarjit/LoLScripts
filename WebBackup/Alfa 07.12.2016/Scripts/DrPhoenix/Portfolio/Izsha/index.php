...
<html>
	...
	<body onbeforeunload="do_update()">
		<div class="content">
			...
			<div class="main">
				<h1 class="portfolio_title contributor">Izsha</h1>
				<center><a href="https://forum.botoflegends.com/user/497609-izsha/" class="download_link">Izsha BoL profile</a></center>
				
				<h2 class="sub_title">Thread design : Vayne - Legacy Of Shadow</h2>
				<img class="portfolio_img" src="vayne.png">
				
				<h2 class="sub_title">Signature</h2>
				<img class="portfolio_img" src="signature.png">
				
				<h2 class="sub_title">Signature v2</h2>
