...
<html>
	...
	<body onbeforeunload="do_update()">
		<div class="content">
			...
			<div class="main">
				<h1 class="portfolio_title staff">JaiKor</h1>
				<center><a href="https://forum.botoflegends.com/user/45474-jaikor/" class="download_link">JaiKor BoL profile</a></center>
				
				<h2 class="sub_title">Thread Design : HTTF Viktor</h2>
				<img class="portfolio_img" src="viktor.png">
				
				<h2 class="sub_title">Thread Design : GiveAway Event #$aveThatMoney</h2>
				<img class="portfolio_img" src="giveaway.png">
			</div>
