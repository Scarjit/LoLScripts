...
<html>
	...
	<body onbeforeunload="do_update()">
		<div class="content">
			...
			<div class="main">
				<h1 class="portfolio_title scripter">Spyk</h1>
				<center><a href="https://forum.botoflegends.com/user/747775-spyk/" class="download_link">spyk BoL profile</a></center>
				
				<h2 class="sub_title">Korean Top Signature</h2>
