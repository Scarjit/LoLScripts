		...
		<div class="content">
			...
			<div class="main">
				...
				<h1 class="title">Features</h1>
					<ul class="list">
						<li>Show a funny text relevant to your KDA (local only)</li>
					</ul>
				
				<h1 class="title">Download</h1>
					<center><a href="http://s1mplescripts.de/DrPhoenix/BoL/Scripts/DoctorSentences/DoctorSentences.lua" download class="download_link">Direct download link, direct challenger promotion !</a></center>
					<center><a href="https://forum.botoflegends.com/topic/94427-67free-doctor-sentences-get-some-fun-during-your-game/" class="download_link">Visit the forum thread to see what users said about it !</a></center>
