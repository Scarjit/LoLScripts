...
<html>
	...
	<body onbeforeunload="do_update()">
		<div class="content">
			...
			<div class="main">
				<h1 class="portfolio_title">Navimus</h1>
				<center><a href="https://forum.botoflegends.com/user/61282-navimus/" class="download_link">Navimus BoL profile</a></center>
				
				<h2 class="sub_title">Thread design : Vel'Koz - Eye of the Meme</h2>
				<img class="portfolio_img" src="velkoz.png">
			</div>
