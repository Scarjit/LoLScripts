	...
	<div class="container marketing">
	  ...
	  <div class="row">
		<div class="col-lg-4">
		  ...
		  <h2>S1mple_Ziggs</h2>
		  <p>My first Cloudrop Addon, made for Ziggs.</p>
		  <p><a class="btn btn-default" href="Scripts/Cloudrop/Ziggs/Ziggs.zip" role="button">Download</a></p>
		</div><!-- /.col-lg-4 -->
		<div class="col-lg-4">
		  <img class="img-circle" src="images/Veigar.jpg" alt="Generic placeholder image" width="140" height="140">
		  <h2>S1mple_Veigar</h2>
		  <p>My Veigar Addon for Cloudrop.</p>
		  <p><a class="btn btn-default" href="Scripts/Cloudrop/Veigar/Veigar.zip" role="button">Download</a></p>
		</div><!-- /.col-lg-4 -->
		<div class="col-lg-4">
		  <img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140">
		  <h2>S1mple_Activator</h2>
		  <p>A simple Item Activator Addon</p>
		  <p><a class="btn btn-default" href="Scripts/Cloudrop/Activator/Activator.zip" role="button">Download</a></p>
		</div><!-- /.col-lg-4 -->
		<div class="col-lg-4">
		  <img class="img-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140">
		  <h2>S1mple_AntiAFK</h2>
		  <p>Allows you to go AFK, without Penalty</p>
		  <p><a class="btn btn-default" href="Scripts/Cloudrop/AntiAFK/AntiAFK.zip" role="button">Download</a></p>
		</div><!-- /.col-lg-4 -->
	  </div><!-- /.row -->
