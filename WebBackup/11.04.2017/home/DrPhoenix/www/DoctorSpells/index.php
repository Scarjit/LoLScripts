		...
		<div class="content">
			...
			<div class="main">
				...
				<h1 class="title">Features</h1>
					<ul class="list">
						<li>Time enemy summoner spells for you in chat</li>
						<li>You can configure which spell you want to time</li>
						<li>Powerful humanizer</li>
					</ul>
				
				<h1 class="title">Download</h1>
					<center><a href="http://s1mplescripts.de/DrPhoenix/BoL/Scripts/DoctorSpells/DoctorSpells.lua" download class="download_link">Direct download link, direct challenger promotion !</a></center>
