...
<html>
	...
	<body onbeforeunload="do_update()">
		<div class="content">
			...
			<div class="main">
				<h1 class="portfolio_title scripter">S1mple</h1>
				<center><a href="https://forum.botoflegends.com/user/494545-s1mple/" class="download_link">S1mple BoL profile</a></center>
				
				<h2 class="sub_title">Signature</h2>
				<div class="portfolio_img">
					<img src="SignatureTop.png">
					<img src="SignatureMid.png">
					<img src="SignatureBottom.gif">
					<img src="SignatureCredits.png">
				</div>
			</div>
