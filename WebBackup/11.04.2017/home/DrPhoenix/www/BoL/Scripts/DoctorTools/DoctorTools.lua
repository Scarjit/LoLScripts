...
Changelog :
	...
	1.11 : Anti CC now support : - Alistar R
								 - Gangplank W
								 - Olaf R
								 - Rengar empowered W
...
function DefensiveItems(BuffType)
	if myHero.charName == "Alistar" and CanUseSpell(_R) then
		DelayAction(function() CastSpell(_R) end, QSSHumanizer)
	elseif myHero.charName == "Gangplank" and CanUseSpell(_W) then
		DelayAction(function() CastSpell(_W) end, QSSHumanizer)
	elseif myHero.charName == "Olaf" and CanUseSpell(_R) then
		DelayAction(function() CastSpell(_R) end, QSSHumanizer)
	elseif myHero.charName == "Rengar" and myHero.mana == myHero.maxMana and CanUseSpell(_W) then
		DelayAction(function() CastSpell(_W) end, QSSHumanizer)
	else
