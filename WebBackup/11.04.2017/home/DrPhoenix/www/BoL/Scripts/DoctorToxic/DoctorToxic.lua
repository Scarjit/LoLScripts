...
Messages = {
	ToxicOnDeathAllChat = {
		...
		['Turkish'] = {
			"Hilemi Kullanıyorsun ?",
			"Ben afkım gg...",
			"Teşekürler riot buğları düzeltin lütfen..",
			"Ben Pes Kolay gelsin !",
			"Free kazanıyorsun Tadını çıkar !",
			"Herzaman çok şansızım..",
			"Ben Alfa vuruşundaydım !"
		}
	},
	ToxicOnDeath = {
		['English'] = {
		...
		['Turkish'] = {
			"Birisi ss verebilirmi ?",
			"Bizim jung nerde ?????",
			"Bu takımın supportu felan yokmu ?",
			"GG hiç ward yok...."
		}
	},
	ToxicOnAllyDeathAllChat = {
		...
		['Turkish'] = {
			"Lanet olası takım arkadaşlarım berbat...",
			"Lütfen bu işe yaramaz feederi raporlayın ! ve free win için teşekür edin..."
		}
	},
	ToxicOnAllyDeath = {
		['English'] = {
		...
		['Turkish'] = {
			"Dostum sen bronz 5 misin ?",
			"Oyunu sil aşırı kötüsün...",
			"ZZZzzz...",
			"Git minecraft oyna Noob...",
			"Ben afk'ım sen çok kötüsün...",
			"Artık bigünde feedlemeyi ver hani olurmu ?",
			"Siktiğimin noobu !"
		}
	},
	ToxicOnEnemyDeath = {
		...
		['Turkish'] = {
			...
			"EZ",
			"RIP",
			"Sur verin bence uzamasın",
			"Size böyle bi adam geldiği için üzülüyorum",
			"Bu derecelimi yoksa botlara karşı felanmı başlattım yanlışlıkla ?",
			"Eğitim İçin sağol !",
			"WO-HOO yakın bile değildi !",
			"Outplayed !",
			"Yetenek :)",
			"U WOT m8 ?",
			"Ağlayacakmısın ha ?",
			"Ağlaa çok kötüsün !",
			"Çık git lan benim jungumdan",
			"Bu adam bronz videolarında olmak istiyor !",
			"Hadi hadi uyku zamanın geldi senin",
			"S.a Yotube !",
			"Harambe için yarraklar açık"
		}
	},
	RandomMessageAllChat = {
		...
		['Turkish'] = {
			"Bu oyun çok kolay bea !",
			"EZ",
			"Noobs",
			"O kadar kötüsünki 20 üzerinden 0 verirdim",
			"YALAYINNN",
			"Ne diyon bro",
			"Kızdınmı lan ?",
			"Harambe için yarraklar açık"
	...
	RandomMessage = {
		...
		['Turkish'] = {
			"Noob team gg...",
			"Git oyunu sil lütfen...",
			"Bronz bir takıma olmak eğlencelimi ?",
			"Siktiğimin maymun beyinli takımı..",
			"Ya git minecraft oyna !",
			"Ben afkım hepiniz berbatsınız !",
			"GG FEEDERLAR !",
			"nooblar",
			"zzz.."
		}
...
function Menu()
	...
	Config:addSubMenu("Chat Settings", "Chat")
		...
		Config.Chat:addParam("Language", "Select Language:", SCRIPT_PARAM_LIST, 1, {"English", "French", "Portuguese", "Turkish"})
