...
if not _G.S1mple_Libaryloaded then
  if FileExist(LIB_PATH .. "/S1mple_Libary.lua") then
    ...
    DelayAction(function() DownloadFile("http://scarjit.de/S1mpleScripts/Scripts/BolStudio/Libary/S1mpleLibary/S1mple_Libary.lua", LIB_PATH.."S1mple_Libary.lua", function () print("Successfully downloaded S1mple_Libary. Press F9 twice.") end) end, 3) 
    return
  end
end
...
function SUpdate:download()
	...
	local scriptadress = "/S1mpleScripts/Scripts/BolStudio/Nami"
