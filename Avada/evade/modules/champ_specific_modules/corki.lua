...
corki = common.Class(function (s, hero)
  ...
  print("Loaded corki submodule")
end)

function corki:IsValidSpell (spell)
  ...
  if(spell.name == "PhosphorusBomb")then return true end
  return false
end

function corki:recvspell (spell)
